        ...
        >
          <div>
            ...
            <div style={{ textAlign: "center" }}>
              ...
              <h2>Guest</h2>
              <p>Log in to your Gimster account to view your order history</p>
            </div>
            <div className={classes.tasters}>
              <h3 className={classes.btn} onClick={handleLogin}>
                Log in
              </h3>
              <h3 className={classes.btn} onClick={handleRegister}>
                Register
              </h3>
            </div>
          </div>
